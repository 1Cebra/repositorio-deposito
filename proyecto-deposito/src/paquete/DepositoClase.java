...
public class DepositoClase {    
    ...
    public DepositoClase () { //Lo que hace es llamar al constructor con parámetros pasándole valores vacíos
        this(0,0,"");            } //Cierre del constructor


    //Constructor de la clase que pide los parámetros necesarios
    public DepositoClase (float valor_diametro, float valor_altura, String valor_idDeposito) {
